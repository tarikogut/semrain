...
class OyunlarController extends Controller
{
    public function index()
    {
        ...
        return view('admin.oyunlars.index', compact('oyunlars'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.oyunlars.create');
    }
    ...
    public function store(StoreOyunlarRequest $request)
    {
        ...
        return redirect()->route('admin.oyunlars.index');
    }
    ...
    public function edit(Oyunlar $oyunlar)
    {
        ...
        return view('admin.oyunlars.edit', compact('oyunlar'));
    }
    ...
    public function show(Oyunlar $oyunlar)
    {
        ...
        return view('admin.oyunlars.show', compact('oyunlar'));
    }
