...
class BonustimeController extends Controller
{
    public function index()
    {
        ...
        return view('admin.bonustimes.index', compact('bonustimes'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.bonustimes.create');
    }
    ...
    public function store(StoreBonustimeRequest $request)
    {
        ...
        return redirect()->route('admin.bonustimes.index');
    }
    ...
    public function edit(Bonustime $bonustime)
    {
        ...
        return view('admin.bonustimes.edit', compact('bonustime'));
    }
    ...
    public function show(Bonustime $bonustime)
    {
        ...
        return view('admin.bonustimes.show', compact('bonustime'));
    }
