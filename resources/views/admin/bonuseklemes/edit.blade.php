...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.bonuseklemes.update", [$bonusekleme->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('oyun_adi') ? 'is-invalid' : '' }}" type="text" name="oyun_adi" id="oyun_adi" value="{{ old('oyun_adi', $bonusekleme->oyun_adi) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('yatirim') ? 'is-invalid' : '' }}" type="number" name="yatirim" id="yatirim" value="{{ old('yatirim', $bonusekleme->yatirim) }}" step="0.01">
