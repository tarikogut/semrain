    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.bonuseklemes.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="oyun_adi" id="oyun_adi" value="{{ old('oyun_adi', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="yatirim" id="yatirim" value="{{ old('yatirim', '0') }}" step="0.01">
